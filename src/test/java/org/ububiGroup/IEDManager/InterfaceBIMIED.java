...
public class InterfaceBIMIED
{
    ...
    {
        filePath = File.createTempFile("tmp",".test").getPath();
    }
    ...
    @Test
    public void testModuleInterfaceMaterial() throws IOException, SAXException
    {
        ...
        try(baseExporter exp = new IEDExporter())
        {
            exp.init(filePath);
        ...
        try(baseImporter imp = new IEDImporter())
        {
            imp.init(filePath);
    ...
    @Test
    public void testModuleInterfaceObject() throws IOException, SAXException
    {
    ...
    @Test
    public void testModuleInterfaceObjectType() throws IOException, SAXException
    {
